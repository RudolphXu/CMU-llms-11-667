...
work_station = "Chenxiao's windows"
if work_station == "Chenxiao's windows":
    project_dir_path = 'c:\\users\\chenx\\dropbox\\online_course\\cmu_cs11-667\\2024fall\\assignment\\a4\\hw4-dev-student'
    
sys.path.insert(0,
                os.path.join(project_dir_path, 'src')
                )
